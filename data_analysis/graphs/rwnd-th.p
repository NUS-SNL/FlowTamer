set ylabel "Sender Throughput [Mbps]" offset 2,0,0
...
plot 'summary_cubic_10ms_100Mbps.dat' using 1:2 with lines title 'cubic', \
'summary_reno_10ms_100Mbps.dat' using 1:2 with lines title 'reno', \
'summary_bbr_10ms_100Mbps.dat' using 1:2 with lines title 'bbr', \
