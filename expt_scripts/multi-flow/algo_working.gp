...
set multiplot layout 3,1 margins 0.12,0.95,.15,0.92 spacing 0,0 title plottitle
...
plot flowrwnd1dat using ($1-mints):($2 / 1000) with lines title flowrwnd1title lt rgb "red", \
    ...
    algorwnddat using ($1-mints):($2 * 2/ 1000) with lines title algorwndtitle lt rgb "black" dashtype 2
